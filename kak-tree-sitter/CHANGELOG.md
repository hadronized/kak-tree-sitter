...
- Do not fail initialization if default highlighter was not found [9ad8d28](https://github.com/hadronized/kak-tree-sitter/commit/9ad8d28)

# v1.1.1

## Bug fixes

- Properly disable **tree-sitter** when using `tree-sitter-session-end`. [142a245](https://github.com/hadronized/kak-tree-sitter/commit/)
- Fix removing default highlighter in already existing buffers. [46279fe](https://github.com/hadronized/kak-tree-sitter/commit/)

# v1.1.0

## Features

- Implement Split text-object. [9d4b9f4](https://github.com/hadronized/kak-tree-sitter/commit/9d4b9f4)
...
- Properly remove default highlighter. [8a76d3a](https://github.com/hadronized/kak-tree-sitter/commit/8a76d3a)
...
- Fix coordinate conversion in navigation [6506bff](https://github.com/hadronized/kak-tree-sitter/commit/6506bff)
- Fix crash when highlighter fails to load for a language. [8cb1acd](https://github.com/hadronized/kak-tree-sitter/commit/8cb1acd)
