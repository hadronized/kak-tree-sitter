...
set-face global ts_markup_list_checked          "%opt{mauve}"
set-face global ts_markup_list_numbered         "%opt{mauve}"
set-face global ts_markup_list_unchecked        "%opt{mauve}"
set-face global ts_markup_list_unnumbered       "%opt{mauve}"
set-face global ts_markup_link_label            "%opt{blue}"
set-face global ts_markup_link_url              "%opt{mauve}+u"
set-face global ts_markup_link_text             "%opt{blue}"
set-face global ts_markup_quote                 "%opt{gray1}"
set-face global ts_markup_raw_block             "%opt{flamingo}"
set-face global ts_markup_raw_inline            "%opt{flamingo}"
