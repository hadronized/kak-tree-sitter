...
set-face global ts_markup_heading_2             "%opt{mauve}+b"
set-face global ts_markup_heading_3             "%opt{green}+b"
set-face global ts_markup_heading_4             "%opt{yellow}+b"
set-face global ts_markup_heading_5             "%opt{pink}+b"
set-face global ts_markup_heading_6             "%opt{teal}+b"
...
set-face global ts_markup_raw_inline            "%opt{sky}"
