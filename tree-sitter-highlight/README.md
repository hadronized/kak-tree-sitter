This crate is a modified version of [tree-sitter-highlight](https://docs.rs/tree-sitter-highlight/latest/tree_sitter_highlight/) version 0.20.1 to work better for a generalized tree-sitter tool.
